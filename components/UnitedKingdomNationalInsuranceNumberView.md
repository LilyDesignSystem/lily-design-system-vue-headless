...
A headless Vue 3 read-only display for United Kingdom's National Insurance Number (NINO).
...
References: https://en.wikipedia.org/wiki/National_Insurance_number
