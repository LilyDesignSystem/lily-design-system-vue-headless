...
A headless Vue 3 read-only display for Czech Republic's Rodné číslo (RČ).
...
References: https://en.wikipedia.org/wiki/National_identification_number#Czech_Republic
