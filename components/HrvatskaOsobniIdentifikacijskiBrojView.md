...
A headless Vue 3 read-only display for Croatia's Osobni identifikacijski broj (OIB).
...
References: https://en.wikipedia.org/wiki/Personal_identification_number_(Croatia)
