...
A headless Vue 3 input for Bulgaria's Единен граждански номер / Edinen grazhdanski nomer (EGN).
...
References: https://en.wikipedia.org/wiki/Unique_citizenship_number
